    ...
    const fetchInspect = async () => {
      try {
        ...
        setData({
          ...
          tag: imageTag,
          name: stableId,
          displayName: currentOverride.displayName || labels['casaos.reborn.name'] || labels['casaos.app.name'] || '',
          icon: currentOverride.icon || labels['casaos.reborn.icon'] || labels['icon'] || '',
          env: parsedEnv,
          ports: parsedPorts,
